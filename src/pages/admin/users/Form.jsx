        ...
        .then(res => {
            if(res.status){
              ...
              setFormData({
                ...
                address_line_1: user.details?.address_line_1 ?? "",
                address_line_2: user.details?.address_line_2 ?? "",
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
                <div className="col-md-12 mb-3">
                    ...
                    <input type="file" id="profile_image" name="profile_image" className={`form-control ${errors.profile_image ? "is-invalid" : ""}`} accept="image/*" onChange={handleFileChange} />
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <input type="password" id="confirm_pass" name="confirm_pass" className={`form-control ${errors.confirm_pass ? "is-invalid" : ""}`} value={formData.confirm_pass} onChange={handleChange} placeholder="Enter confirm_pass" />
                ...
                <div className="col-md-6 mb-3">
                    <label htmlFor="address_line_2" className="form-label required">Address Line 2</label>
